...
namespace JsonCrafterOld.Serialization
{
    ...
    /// </summary>
    public abstract class ResourceConverterBase<TLogger> where TLogger: class, ILogger
    {
        protected readonly IResourceContractResolver Resolver;
        protected readonly TLogger Logger;

        protected ResourceConverterBase(IResourceContractResolver resolver, TLogger logger)
        {
